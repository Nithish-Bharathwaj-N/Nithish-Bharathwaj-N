...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <ul>
        <li>🎓 <b>Education:</b> B.Tech in CSE (Cybersecurity) @ Chennai Institute of Technology</li>
        <li>💡 <b>Specialization:</b> Full-Stack Web Architecture, AI Engineering & Cybersecurity</li>
        <li>🏆 <b>Recognition:</b> Finalist in 5+ National-Level Hackathons</li>
    ...
    <td width="50%" valign="top">
      ...
      <ul>
        <li>🛡️ <b>Cybersecurity:</b> Threat Intelligence, Network Forensics, CTF, Vulnerability Assessment</li>
        <li>🤖 <b>AI & ML:</b> LLM Integration, Prompt Engineering, Predictive Models, Foundation Models</li>
        <li>💻 <b>Software Engineering:</b> MERN Stack, Socket.IO Real-Time Engine, REST APIs, System Design</li>
        <li>☁️ <b>Cloud & DevOps:</b> AWS AI Services, Docker Containerization, Linux Systems</li>
      </ul>
    </td>
  </tr>
</table>
...
- **Generative AI Virtual Intern** — *AWS Academy × AICTE × EduSkills* `[10/2025 – 12/2025]`
  - Completed intensive 10-week virtual program covering Large Language Models (LLMs), Prompt Engineering, and Foundation Models.
  - Worked hands-on with AWS AI Services to architect scalable, cloud-native generative AI applications.
...
- 🖥️ **Operating Systems Fundamentals** — *Cisco Networking Academy*
...
| ☁️ **Scalable Infrastructure** | Building modular microservices using Docker, AWS, PostgreSQL, MySQL, Socket.IO, and Linux kernels. |
...
<div align="center">
  <img src="https://img.shields.io/badge/Problems_Solved-500+-FFA116?style=for-the-badge&logo=leetcode&logoColor=white" alt="Problems Solved" />
  <img src="https://img.shields.io/badge/Contest_Rating-1771-3B82F6?style=for-the-badge&logo=leetcode&logoColor=white" alt="Contest Rating" />
  <img src="https://img.shields.io/badge/Streak-118_Days-22C55E?style=for-the-badge&logo=leetcode&logoColor=white" alt="118 Days Streak" />
...
> Open to collaborating on **Full-Stack AI Platforms**, **Cybersecurity Research**, **Open-Source Tools**, and **Real-Time Distributed Architectures**.
...
<div align="center">
  ...
  <br /><br />
  <img src="https://komarev.com/ghpvc/?username=Nithish-Bharathwaj-N&label=Profile%20Views&color=38BDF8&style=flat-square" alt="Visitor Counter" />
</div>
